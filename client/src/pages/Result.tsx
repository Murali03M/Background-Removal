          ...
          <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm '>
              <div className='flex flex-col sm:grid grid-cols-2 gap-8'>
                  ...
                  <div className='flex flex-col'>
                      ...
                      {/* <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2l'>
                          <div className='border-4 border-violet-600 rounded-full h-12 w-12 animate-spin border-t-transparent'></div>
                          </div>*/}
                 </div> 
                  </div>
              </div> 
              <div className='flex sm:justify-end   justify-center items-center flex-wrap gap-6 mt-6'>
                  ...
                  <a href='' className='px-8 py-2.5 bg-gradient-to-r from-violet-600 to-fuchsia-500 rounded-full hover:scale-105  transition-all duration-700 text-white'>Download image</a>
              </div>
          </div>
