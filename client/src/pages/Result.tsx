...
const Result = () => {
  ...
  return (
      <div className='mx-4 my-4 lgh:mx-44 mt-14 min-h-[85vh] '>
          <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm '>
              <div className='flex flex-col sm:grid grid-cols-2 gap-8 '>
                  <div>
                      <p className='font-semibold text-gray-600 mb-2'>Original</p>
                      <img src={image? URL.createObjectURL(image):assets.image_w_bg} alt="image_w_bg" className='rounded-md border bg-cover'/>
                  </div>
                  <div className='flex flex-col'>
                      ...
                      <div  className='rounded-md border border-gray-300 h-full relative bg-layer overflow-hidden'>
                          ...
                          <img src={resultImage ? resultImage : ""} alt="image_wo_bg"  className='bg-cover'/>
                          {
              ...
              </div> 
              {
                  resultImage && <div className='flex sm:justify-end   justify-center items-center flex-wrap gap-6 mt-6'>
                      <input onChange={updateHander} accept="image/*" type="file" name="" id="upload3" hidden/>
